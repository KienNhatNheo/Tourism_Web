...
<body>
    ...
    <div style="text-align: center;font-size: 30px;margin-top: 30px;margin-bottom: 30px;"><?php if($key == 1){
                    echo 'Bạn thay đổi mật khẩu thành công!';
                } else {
                    echo 'Bạn đổi mật khẩu thất bại!';
                } 
                ?><br></div>
