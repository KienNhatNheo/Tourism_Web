...
<body>
    ...
    <?php foreach($user_detail as $item){ ?>
        <div style="display: flex;margin-left: 12.5%;margin-right: 12.5%;margin-bottom: 30px;">
            <div>
                <form action="../user_controller/update_user_detail_form" method="post">
                    <table>
                        <tr>
                            <th><label>Tên người dùng</label></th>
                            <td><input type="text" name="fullname" value="<?php echo $item->fullname; ?>"></td>
                        </tr>
                        <tr>
                            <th><label>Email</label></th>
                            <td><input type="email" name="email" value="<?php echo $item->email; ?>"></td>
                        </tr>
                        <tr>
