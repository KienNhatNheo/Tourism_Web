...
<body>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="./shop-grid.html">Shop</a></li>
                            <li><a href="../user_controller/history">History</a></li>
                            <li class="active"><a href="../user_controller/contact">Contact</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <!-- Map Begin -->
    <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3725.7826576818084!2d105.7452841147621!3d20.961241586035097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313452efff394ce3%3A0x391a39d4325be464!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBQSEVOSUtBQQ!5e0!3m2!1svi!2s!4v1649077704392!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <div class="contact-form spad">
        <div class="container">
            ...
            <form action="../user_controller/add_contribution" method="post">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <textarea placeholder="Your message" name="contribution"></textarea>
