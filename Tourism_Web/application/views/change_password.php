...
<body>
    ...
    <div style="text-align: center;font-size: 30px;margin-top: 30px;margin-bottom: 30px;">Sửa thông tin người dùng<br></div>
        <div style="display: flex;margin-left: 12.5%;margin-right: 12.5%;margin-bottom: 30px;">
            <div>
                <form action="../user_controller/change_password_result" method="post">
                    <table>
                        <tr>
                            <th><label>Mật khẩu cũ</label></th>
                            <td><input type="password" name="pre_pass"></td>
                        </tr>
                        <tr>
                            <th><label>Mật khẩu mới</label></th>
                            <td><input type="password" name="new_pass"></td>
                        </tr>
                        <tr>
                            <th><label>Xác nhận mật khẩu mới</label></th>
