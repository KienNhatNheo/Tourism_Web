...
<head>
    ...
    <link rel = "stylesheet" type = "text/css" href = "<?php echo base_url('assets/css/font-elegant-icons.css');?>">
    <link rel = "stylesheet" type = "text/css" href = "<?php echo base_url('assets/css/elegant-icons.css');?>">
