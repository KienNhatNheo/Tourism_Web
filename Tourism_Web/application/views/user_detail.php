        ...
        <div style="display: flex;margin-left: 12.5%;margin-right: 12.5%;margin-bottom: 30px;">
            ...
            <div >
                ...
                <div style="display:flex;margin:2rem;justify-content: space-between;">
                	<a href="../user_controller/update_user_detail" ><button class="btn btn-success">Sửa thông tin</button></a>
                	<a href="../user_controller/change_password" ><button class="btn btn-success">Đổi mật khẩu</button></a>
                </div>  
            </div>
        </div>
    <div>
