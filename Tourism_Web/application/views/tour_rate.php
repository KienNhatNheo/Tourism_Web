...
<body>
    ...
    <div style="text-align: center;font-size: 30px;margin-top: 30px;margin-bottom: 30px;">Đánh giá chuyến đi : <?php echo $item->tour_name; ?></div>
    <form action="../tour_rate_handle" method="post">
        <table style="margin-left:12%">
            <tr>
                <td ><label>Số điểm đánh giá</label></td>
                <td style="padding-left: 10px;"><input type="text" name="rate_point">/5</td>
            </tr>
            <tr>
                <td><label>Phản hồi về chuyến đi</label></td>
                <td style="padding-left: 10px;"><input type="form_textarea" name="feedback" style="width:500px;" placeholder="Phản hồi của bạn ..."></td>
            </tr>
        </table>
        <input type="hidden" name="tour_id" value="<?php echo $item->tour_id; ?>">
        <input style="margin-left:12%;background-color: green;color:white;" type="submit" style="btn btn-success" name="" value="Gửi đánh giá">
    </form>   
    <?php } ?>
